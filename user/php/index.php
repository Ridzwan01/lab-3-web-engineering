    ...
    <body>
        <div class="w3-cyan">    
            <div class="w3-bar">
                ...
                <div>
                    <form class="w3-right" name="loginForm" action="index.php" method="POST">
                        <input class=" w3-round" type="search" name="valuesearch" placeholder="Search Subject">
                        <input class="w3-yellow w3-round" type="submit" name="submit"></button>
                    </form>
                </div>
            </div>    
            ...
            <div class="w3-container">
                <h3>My Tutor</h3>
                <a class="w3-bar-item w3-button w3-right" href="addsubject.php">Add Subject</a>
            </div>
        </div>
